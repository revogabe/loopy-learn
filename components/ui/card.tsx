...
export function Card({ className, ...props }: CardProps) {
  return (
    <div
      className={cn("overflow-hidden rounded-lg border border-primarycolor", className)}
      {...props}
    />
  )
}
...
Card.Header = function CardHeader({ className, ...props }: CardHeaderProps) {
  return <div className={cn("grid gap-1 p-6 text-primarycolor", className)} {...props} />
}
...
Card.Footer = function CardFooter({ className, ...props }: CardFooterProps) {
  return (
    <div
      className={cn(" border-t border-primarycolor bg-black px-6 py-4", className)}
      {...props}
    />
  )
}
...
Card.Title = function CardTitle({ className, ...props }: CardTitleProps) {
  return <h4 className={cn("text-lg font-medium text-primarycolor", className)} {...props} />
}
