  ...
  return (
    <div className="container flex h-screen w-screen flex-col items-center justify-center ">
      ...
      <div className="mx-auto flex w-full flex-col justify-center space-y-6 rounded-lg border border-primarycolor p-12 shadow-xl shadow-black/50 sm:max-w-lg">
        ...
        <UserAuthForm />
        <p className="px-8 text-center text-sm text-gray-500 dark:text-gray-200">
          <Link
            href="/register"
            className="hover:text-brand text-gray-500 underline underline-offset-4 transition-all duration-300 ease-out hover:text-primarycolor"
          >
